<script>
  ...
  $: pos = $page.route.id === "/" ? "self-start" : $page.route.id === "/me" ? "self-end" : "self-center";
...
<div class="fixed view-stay w-72 bottom-5 left-[calc(50%-18rem/2)] flex flex-col group">
  <div
  ...
  <div class="bg-primary flex-row flex h-16 bouncy duration-300 hover:h-20 rounded-xl z-50 shadow-2xl peer">
    <a
      class="border-2 border-secondary m-1 w-1/3 rounded-lg justify-center items-center flex font-space text-3xl text-content bouncy duration-500 hover:w-1/2 ease-out hover:text-secondary hover:border-content hover:bg-content select-none nav-item"
      data-tooltiptext="Home / Updates"
      href="/"><span class="material-symbols-outlined">home</span></a
    >
    <a
      class="border-2 border-secondary m-1 w-1/3 rounded-lg justify-center items-center flex font-space text-3xl text-content bouncy duration-500 hover:w-1/2 ease-out hover:text-secondary hover:border-content hover:bg-content select-none nav-item mx-0"
      data-tooltiptext="Projects"
      href="/work"><span class="material-symbols-outlined">work</span></a
    >
    <a
      class="border-2 border-secondary m-1 w-1/3 rounded-lg justify-center items-center flex font-space text-3xl text-content bouncy duration-500 hover:w-1/2 ease-out hover:text-secondary hover:border-content hover:bg-content select-none nav-item"
